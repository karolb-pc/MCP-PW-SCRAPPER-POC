...
from src.etl.extractor.books import BooksToScrapeExtractor
from src.etl.loader.local_json import LocalJsonLoader
from src.etl.transformer.books import BooksToScrapeTransformer
...
CONFIG = {
    "extractor": {
        ...
        "params": {
            "source_url": general_settings.source_url,
        },
    },
    "transformer": {
        "_class": BooksToScrapeTransformer,
        "params": {
            "source_name": general_settings.source_name,
            "source_url": general_settings.source_url,
        },
    },
    "validator": {
