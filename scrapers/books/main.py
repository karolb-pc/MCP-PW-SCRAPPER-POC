...
from scrapers.books.etl import CONFIG, BooksToScrapeETL
...
@click.group()
def cli() -> None:
    """Books to Scrape self-healing scraper commands."""
...
def run(
    ...
    browser_mode = browser or os.getenv("SCRAPER_BROWSER", "playwright").lower()
